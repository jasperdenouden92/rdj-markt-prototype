...
import { Send, MailOpen, Check, X, Ship, Warehouse, PanelRight, ListTodo } from "lucide-react";
...
export default function LadingDetail() {
  ...
  return (
    <div className="flex min-h-screen bg-white">
      <Sidebar data-annotation-id="ladingdetail-navigatie" />
                    ...
                    <div className="w-full pt-[20px]">
                      {activeTab === 'matches' && (
                        <>
                          ...
                          />
                          <Pagination data-annotation-id="ladingdetail-paginering-2"
                          ...
                          />
                          <Table data-annotation-id="ladingdetail-tabel-2"
                      ...
                      {activeTab === 'onderhandelingen' && (
                        <>
                          ...
                          />
                          <Table data-annotation-id="ladingdetail-tabel"
