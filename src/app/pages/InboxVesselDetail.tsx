...
export default function InboxVesselDetail() {
  ...
  const vesselNegotiations = [
    ...
    { id: 'N002', aanbod: 'Staal Dordrecht', aanbodSubtext: '3.000 ton Staal', bron: 'markt' as const, company: 'Janlow B.V.', ladingRelatie: 'Janlow B.V.', freightPrice: '€3,00/ton', freightPriceDiff: '-3,2%', tonnage: '3.000 ton', deadline: 'Morgen, 9:00', deadlineExpired: true, status: 'In onderhandeling', contact: { name: 'Pelger de Jong', date: 'Di 10 Mrt 19:53' }, bemiddeling: { inkoopRelatie: 'Provaart Logistics BV', verkoopRelatie: 'Janlow B.V.' } as const },
