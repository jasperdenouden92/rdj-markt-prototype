...
const vesselNegotiations = [
  ...
  { id: 'VN003', company: 'Cargill N.V.', cargo: '2.000 ton Koolraapzaad', price: '', priceDiff: '', laadLocatie: 'Bremerhaven', laadDatum: 'Ma 19 Jan', losLocatie: 'Duisburg', losDatum: 'Wo 21 Jan', deadline: 'Do 19 Feb, 11:15', deadlineExpired: false, status: 'Via werklijst', contact: { name: 'Khoa Nguyen', date: 'Zo 8 Feb 01:31' }, bemiddeling: { inkoopRelatie: 'Rederij Alfa', verkoopRelatie: 'Cargill N.V.' } as const },
];
