          ...
          <PageHeader
            ...
            filtersRight={
              <>
                {viewMode === 'list' && (
                  <>
                    <p className="font-['Hanken_Grotesk:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#344054] text-[14px] whitespace-nowrap">Groeperen:</p>
