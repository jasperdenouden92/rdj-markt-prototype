...
export const mockContracten: Contract[] = [
  {
    ...
    waarde: 18500,
    laadlocatieNaam: "Rotterdam",
    loslocatieNaam: "Duisburg",
    tonnage: 2500,
    vrachtprijs: 7.40,
  ...
  },
  {
    ...
    routes: [
      { id: "r-001", laadlocatieNaam: "Dordrecht", loslocatieNaam: "Antwerpen", tonnage: 3000, vrachtprijs: 6.80 },
      { id: "r-002", laadlocatieNaam: "Dordrecht", loslocatieNaam: "Gent", tonnage: 2500, vrachtprijs: 7.20 },
    ],
  ...
  },
  {
    ...
    routes: [
      { id: "r-003", laadlocatieNaam: "Amsterdam", loslocatieNaam: "Mannheim", tonnage: 4000, vrachtprijs: 8.50 },
      { id: "r-004", laadlocatieNaam: "Amsterdam", loslocatieNaam: "Basel", tonnage: 3500, vrachtprijs: 11.20 },
      { id: "r-005", laadlocatieNaam: "Amsterdam", loslocatieNaam: "Strasbourg", tonnage: 3000, vrachtprijs: 9.80 },
    ],
  ...
  },
  {
    ...
    status: "gewonnen",
    waarde: 8200,
    laadlocatieNaam: "Barendrecht",
    loslocatieNaam: "Rotterdam Europoort",
    tonnage: 1800,
    vrachtprijs: 4.55,
  ...
  },
  {
    ...
    routes: [
      { id: "r-006", laadlocatieNaam: "Rotterdam", loslocatieNaam: "Antwerpen" },
      { id: "r-007", laadlocatieNaam: "Rotterdam", loslocatieNaam: "Moerdijk" },
    ],
  ...
  },
  {
    ...
    status: "aandacht_nodig",
    waarde: 3500,
    laadlocatieNaam: "Rotterdam Botlek",
    loslocatieNaam: "Rotterdam Botlek",
    tonnage: 5000,
  ...
  },
  {
    ...
    waarde: 12000,
    laadlocatieNaam: "Papendrecht",
    loslocatieNaam: "Papendrecht",
    tonnage: 3000,
  ...
  },
  {
    ...
    eindDatum: "2026-09-30",
    routes: [
      { id: "r-008", laadlocatieNaam: "Rotterdam", loslocatieNaam: "Duisburg", tonnage: 2000, vrachtprijs: 9.50 },
      { id: "r-009", laadlocatieNaam: "Antwerpen", loslocatieNaam: "Duisburg", tonnage: 1800, vrachtprijs: 8.80 },
    ],
  ...
  },
  {
    ...
    eindDatum: "2026-06-30",
    routes: [
      { id: "r-010", laadlocatieNaam: "Rotterdam", loslocatieNaam: "Krefeld", tonnage: 3500, vrachtprijs: 8.10 },
    ],
