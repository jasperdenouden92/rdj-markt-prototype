                ...
                <div className="mt-[8px] flex flex-col gap-[2px] pl-[40px]">
                  ...
                  {cp.telefoon && (
                    <div className="flex items-center gap-[6px]">
                      <div className="shrink-0 size-[14px] text-rdj-text-tertiary">
                        <svg className="block size-full" fill="none" viewBox="0 0 14 14">
                          <path d="M5.13798 5.57852C5.62415 6.59508 6.30605 7.53019 7.13793 8.36207C7.96981 9.19395 8.90492 9.87585 9.92148 10.362L10.0111 10.4053C10.6467 10.7102 11.3776 10.7593 12.0472 10.5421C12.7167 10.325 13.2749 9.85795 13.6072 9.2373L13.7367 8.99825C13.8851 8.72433 13.8987 8.39816 13.7738 8.11321L12.8072 5.90751C12.6789 5.61469 12.4325 5.38766 12.1293 5.28165L10.348 4.65832C10.0375 4.54961 9.69635 4.58722 9.41558 4.76144L8.38973 5.39844C8.38973 5.39844 7.72307 4.73177 7.13923 4.14794C6.5554 3.56411 5.88873 2.89744 5.88873 2.89744L6.52573 1.87159C6.69995 1.59082 6.73756 1.24968 6.62885 0.939138L6.00552 -0.842068C5.89951 -1.14527 5.67248 -1.39167 5.37966 -1.52L3.17396 -2.4866C2.88901 -2.61152 2.56284 -2.59789 2.28892 -2.44949L2.04987 -2.32001C1.42922 -1.98769 0.962171 -1.42956 0.745052 -0.760007C0.527933 -0.0904527 0.577079 0.640536 0.881901 1.27617L0.925219 1.36581C1.41138 2.38236 2.09329 3.31748 2.92517 4.14935C3.75704 4.98123 4.69216 5.66314 5.70871 6.1493" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
                        </svg>
                      </div>
