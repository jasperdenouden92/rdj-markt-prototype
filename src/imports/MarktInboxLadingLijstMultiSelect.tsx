  ...
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Text and supporting text">
      <div className="content-stretch flex flex-col items-start px-[8px] relative w-full">
        <p className="font-sans font-bold leading-[24px] relative shrink-0 text-[#f5f5f6] text-[16px] w-full">2 ladingen geselecteerd</p>
      </div>
    </div>
  );
}
...
function TextPadding8() {
  return (
    <div className="content-stretch flex items-center justify-center px-[2px] relative shrink-0" data-name="Text padding">
      <p className="font-sans font-bold leading-[20px] relative shrink-0 text-[#cecfd2] text-[14px] whitespace-nowrap">Archiveren</p>
    </div>
  );
}
