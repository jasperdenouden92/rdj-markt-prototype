...
function Navigation() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start pt-[32px] relative shrink-0 w-full" data-name="Navigation">
      <Header data-annotation-id="markteigenladingladingdetailonderhandelingtoevoegenempty-4-25477-navigatie-3" />
      <Navigation1 />
    </div>
  );
}
...
function Content() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-start justify-between min-h-px min-w-px relative" data-name="Content">
      <Navigation data-annotation-id="markteigenladingladingdetailonderhandelingtoevoegenempty-4-25477-navigatie-2" />
      <Footer data-annotation-id="markteigenladingladingdetailonderhandelingtoevoegenempty-4-25477-navigatie" />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="Content">
      <div className="content-stretch flex items-center pl-[24px] relative shrink-0" data-name="Breadcrumbs">
        <Tabs data-annotation-id="markteigenladingladingdetailonderhandelingtoevoegenempty-4-25477-tabs" />
      </div>
    </div>
  );
}
...
function InputDropdown() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative" data-name="Input dropdown">
      <List data-annotation-id="markteigenladingladingdetailonderhandelingtoevoegenempty-4-25477-lijst" />
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start max-w-[580px] relative shrink-0 w-[580px]">
      ...
      <Form data-annotation-id="markteigenladingladingdetailonderhandelingtoevoegenempty-4-25477-formulier" />
    </div>
  );
}
...
function Container() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative" data-name="Container">
      <Modal data-annotation-id="markteigenladingladingdetailonderhandelingtoevoegenempty-4-25477-modal" />
    </div>
  );
}
