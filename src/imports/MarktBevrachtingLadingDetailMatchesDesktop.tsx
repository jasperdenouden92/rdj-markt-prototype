...
function Navigation() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start pt-[32px] relative shrink-0 w-full" data-name="Navigation">
      <Header data-annotation-id="marktbevrachtingladingdetailmatchesdesktop-navigatie-3" />
      <Navigation1 />
    </div>
  );
}
...
function Content() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-start justify-between min-h-px min-w-px relative" data-name="Content">
      <Navigation data-annotation-id="marktbevrachtingladingdetailmatchesdesktop-navigatie-2" />
      <Footer data-annotation-id="marktbevrachtingladingdetailmatchesdesktop-navigatie" />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[20px] items-start relative shrink-0 w-full" data-name="Content">
      <div className="content-stretch flex items-center pl-[24px] relative shrink-0" data-name="Breadcrumbs">
        <Tabs data-annotation-id="marktbevrachtingladingdetailmatchesdesktop-tabs" />
      </div>
      <Buttons />
    </div>
  );
  ...
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Tabs">
      <div className="content-stretch flex gap-[8px] h-[32px] items-center justify-center pb-[12px] px-[4px] relative shrink-0" data-name="Tab button base">
        ...
        <p className="font-sans font-bold leading-[20px] relative shrink-0 text-[#145990] text-[14px] whitespace-nowrap">Matches</p>
        <div className="bg-[#f2f8fd] content-stretch flex items-center px-[8px] py-[2px] relative rounded-[9999px] shrink-0" data-name="Badge">
          ...
          <p className="font-sans font-bold leading-[18px] relative shrink-0 text-[#145990] text-[12px] text-center whitespace-nowrap">5</p>
        </div>
      </div>
      <div className="content-stretch flex gap-[8px] h-[32px] items-center justify-center pb-[12px] px-[4px] relative shrink-0" data-name="Tab button base">
        <p className="font-sans font-bold leading-[20px] relative shrink-0 text-[#667085] text-[14px] whitespace-nowrap">Onderhandelingen</p>
      </div>
...
function Container() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-start min-h-px min-w-px relative" data-name="Container">
      <Dropdown />
      <Modal data-annotation-id="marktbevrachtingladingdetailmatchesdesktop-modal" />
    </div>
  );
}
